...
<body>
    ...
    <div class="main">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                <a href="work_add.php" class="btn btn-primary aal">新增作品</a>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                                <a href="work_edit.php?i=<?php echo $value["id"];?>" class="btn btn-warning">編輯</a>
                                <a href="javascript:void(0);" class="del_work btn btn-danger" data-id = "<?php echo $value["id"];?>">刪除</a>
                            </td>
